...
const pillars = [
  {
    ...
    desc: 'Our compact & standard designs result in highly efficient solar installations with premium build quality and an operational life of 30+ years. Every design is optimized for maximum energy yield and minimal maintenance.',
    points: ['Custom site-specific designs', '3D shadow analysis', 'Optimized for Indian weather', 'Net-metering compliant'],
    stat: { value: '30+', label: 'Years Design Life' },
  ...
  },
  {
    ...
    subtitle: 'Only Tier-1 Components',
    desc: 'We use only the most reliable and industry-proven equipment. From N-Type Topcon Bifacial DCR panels to high-efficiency string inverters — every component is selected for peak performance and longevity.',
    points: ['N-Type Topcon 580Wp', 'On-Grid String Inverters', 'Hotdeep GI Structures', 'Waacab/Polycab Cables'],
    stat: { value: '₹61,200', label: 'Per kW Rate' },
  ...
  },
  {
    ...
    desc: 'Strict adherence to inspection and quality assurance protocols at every stage — from equipment manufacturing to on-site execution. ISO-grade quality control ensures your investment delivers returns for decades.',
    points: ['MNRE Approved Standards', 'DISCOM Compliance', 'On-site Quality Audits', 'Performance Testing'],
  ...
  },
  {
    ...
    desc: 'End-to-end Engineering, Procurement & Construction — from initial site survey to final commissioning and beyond. We handle everything so you can simply enjoy the benefits of clean solar energy and massive savings.',
    points: ['Site Survey & Design', 'Supply & Installation', 'Net-Metering Liaison', '5 Year AMC Included'],
...
export default function About() {
  return (
    <section id="about" className="py-20 lg:py-28 relative overflow-hidden bg-mesh">
      ...
      <div className="absolute inset-0 pointer-events-none -z-10">
        {[...Array(6)].map((_, i) => (
          <span key={i} className="absolute bg-emerald-400 rounded-full animate-sparkle-twinkle" style={{ left: `${8 + i * 16}%`, top: `${12 + i * 14}%`, width: `${2 + i % 2}px`, height: `${2 + i % 2}px`, animationDelay: `${i * 0.4}s`, opacity: 0.6 }} />
        ))}
      </div>

      {/* Floating geometric shape */}
      <div className="absolute top-[30%] right-[15%] w-4 h-4 border border-emerald-400/40 rotate-45 animate-diamond-float pointer-events-none -z-10" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <ScrollRevealHeading
            ...
            segments={[
              { text: 'Powering' },
              { text: 'a' },
              { text: 'Sustainable Tomorrow', accent: true },
            ]}
            staggerMs={140}
            threshold={0.4}
          />
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
            Kaustubh Solar Evolution — Your trusted partner for premium solar energy solutions.
            Trusted solar EPC company delivering excellence across Maharashtra and India.
          </p>
        </div>
          ...
          <div className="relative animate-fade-in-up group">
            ...
            <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl shadow-emerald-950/30 border border-white/20 dark:border-slate-800 aspect-[4/5] transform transition-transform duration-1000 group-hover:scale-[1.02]">
              ...
              <div className="absolute top-5 left-5 flex items-center gap-2 px-4 py-2 bg-black/40 backdrop-blur-md rounded-full border border-white/20 shadow-xl">
                ...
                <span className="text-white text-[11px] font-bold tracking-widest uppercase">Premium Solar EPC</span>
              </div>
              ...
              <div className="absolute bottom-6 left-6 right-6 transform transition-all duration-700 group-hover:-translate-y-2">
                <div className="bg-white/10 dark:bg-slate-900/40 backdrop-blur-2xl rounded-[1.5rem] p-5 shadow-2xl border border-white/20">
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <div className="text-3xl font-black text-white tracking-tighter">₹61,200<span className="text-xl font-bold text-emerald-200">/kW</span></div>
                      <div className="text-xs text-emerald-300 font-bold tracking-widest uppercase mt-0.5">Premium KSE EPC</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="absolute top-12 -left-6 md:-left-12 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 p-4 hidden md:flex items-center gap-4 animate-float group-hover:scale-105 transition-transform duration-500" style={{ animationDelay: '2s' }}>
              ...
              <div>
                <div className="text-xl font-black text-slate-900 dark:text-white">ISO 9001</div>
                <div className="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mt-0.5">Certified</div>
              </div>
            </div>
          </div>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="mb-10">
              ...
              <p className="text-base lg:text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-5">
                A leading Solar EPC company providing end-to-end Renewable Energy Solutions for Residential, Commercial, and Industrial purposes. Based in Amravati, Maharashtra, we deliver premium solar solutions with
                <span className="font-black text-emerald-600 dark:text-emerald-400 ml-1">KSE</span> quality and reliability.
              </p>
              <p className="text-base lg:text-lg text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                Our plant design and selection of reliable, proven equipment ensure an operational life of over 30 years with extraordinary returns on investment.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
              {highlights.map((item, idx) => (
                ...
                >
                  <div className="text-3xl font-black bg-gradient-to-br from-emerald-600 to-emerald-400 bg-clip-text text-transparent mb-1.5 group-hover:scale-110 transition-transform duration-500">
                    {item.value}
                  </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              {features.map((feature, idx) => (
                <div
                  key={feature}
                  className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/30 hover:bg-emerald-50 max-w-sm dark:hover:bg-emerald-900/20 transition-colors duration-300 border border-transparent hover:border-emerald-100 dark:hover:border-emerald-800/50"
                  style={{ animationDelay: `${0.5 + idx * 0.1}s` }}
                >
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-500/20">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
              <a
                href="#contact"
                className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-600 to-emerald-400 hover:from-emerald-700 hover:to-emerald-500 text-white font-bold rounded-full shadow-xl shadow-emerald-500/20 hover:shadow-emerald-500/40 transition-all duration-300 group"
              >
        ...
        <div id="services" className="py-16 lg:py-20">
          {/* Section Header */}
          <div className="text-center mb-12 lg:mb-16">
            ...
            <ScrollRevealHeading
              ...
              segments={[
                { text: 'The' },
                { text: 'Four Pillars', accent: true },
                { text: 'of Our Excellence' },
              ]}
            />
            <p className="text-base sm:text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Built on years of industry experience, these four pillars define the premium quality
              that goes into every KSE solar project we deliver.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {pillars.map((pillar, idx) => (
              ...
              >
                ...
                {idx < 3 && (
                  <div className="hidden lg:block absolute top-12 -right-4 w-8 h-px bg-gradient-to-r from-emerald-400 to-transparent z-0 opacity-50 pulse-line"></div>
                )}
                  ...
                  <div className="p-6 pt-10 flex flex-col flex-grow">
                    ...
                    <div className="space-y-2.5 mb-6">
                      {pillar.points.slice(0, 3).map((point) => (
                        <div key={point} className="flex items-center gap-3 text-xs font-bold text-slate-500 dark:text-slate-400">
                    ...
                    {/* Stat */}
                    <div className="pt-5 border-t border-slate-200/50 dark:border-white/10 mt-auto">
                      <div className="flex flex-col">
                        <span className="text-3xl font-black bg-gradient-to-r from-emerald-600 to-emerald-400 bg-clip-text text-transparent">
                          {pillar.stat.value}
                        </span>
                        <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 mt-1">{pillar.stat.label}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-12 lg:mt-16">
            <div className="text-center mb-8">
              ...
              <ScrollRevealHeading
                ...
                segments={[
                  { text: 'Proven Numbers.' },
                  { text: 'Reliable Delivery.', accent: true },
                ]}
              />
              <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                A quick look at the trust, scale, product assurance and service commitment that define Kaustubh Solar Evolution.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  detail: 'Decade-long EPC execution across residential, commercial and industrial segments.',
                  icon: '✨',
                ...
                },
                {
                  ...
                  detail: 'Successfully commissioned rooftop and ground-mounted systems across Maharashtra and beyond.',
                  icon: '🏆',
                  image: 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=1200&auto=format&fit=crop&q=90',
                },
                {
                  value: '30+',
                  label: 'Years Panel Warranty',
                  detail: 'Manufacturer-backed performance assurance on premium N-Type modules.',
                  icon: '🛡️',
                  image: 'https://images.unsplash.com/photo-1559302504-64aae6ca6b6d?w=1200&auto=format&fit=crop&q=90',
                },
                {
                  ...
                  detail: 'Fast-response service, technical guidance and post-installation assistance when you need it most.',
                  icon: '🤝',
                ...
                >
                  <div className="relative h-44 overflow-hidden rounded-t-[2rem]">
                    ...
                    <div className="absolute top-5 left-5 w-12 h-12 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 flex items-center justify-center text-2xl shadow-xl group-hover:scale-110 group-hover:bg-white/20 transition-all duration-500">
                      {item.icon}
                    </div>
                    <div className="absolute bottom-5 left-5 right-5">
                      <div className="text-4xl font-black text-white tracking-tight mb-1 group-hover:text-emerald-300 transition-colors duration-300">{item.value}</div>
                      <div className="text-[10px] font-black text-emerald-400 uppercase tracking-widest">Impact Metric</div>
                    </div>
                  </div>
        ...
        {/* Tagline Banner */}
        <div className="mt-20 text-center relative z-10 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 px-8 sm:px-10 py-6 sm:py-8 bg-gradient-to-r from-emerald-600 via-emerald-500 to-emerald-600 rounded-3xl shadow-2xl shadow-emerald-500/40 hover:shadow-emerald-500/60 transition-all duration-500 hover:scale-[1.02] border border-emerald-400/30 group">
            ...
            <span className="text-white text-xl sm:text-2xl font-black tracking-wide leading-tight">
              Solar Solutions Good for Nature <br className="hidden sm:block" /><span className="text-emerald-100">& Great for Pocket!</span>
            </span>
          </div>
        </div>
      </div>
