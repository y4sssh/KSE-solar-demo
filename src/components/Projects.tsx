...
const featured = {
  title: 'Residential Rooftop – Amravati',
  ...
  tags: ['Turnkey EPC', 'KSE Panels', 'Net Metering', '30 Yr Warranty'],
};
...
const projects: Project[] = [
  ...
  {
    title: 'Industrial Warehouse – Nagpur',
  ...
  {
    title: 'Factory Rooftop – Aurangabad',
  ...
  {
    title: 'Bungalow Rooftop – Amravati',
    location: 'Amravati, Maharashtra',
    capacity: '5 kW',
    panels: '10 Panels',
    technology: 'N-Type Topcon Bifacial',
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-20 lg:py-28 bg-gradient-to-b from-emerald-50/50 to-white dark:from-slate-900 dark:to-slate-950 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
            Explore our portfolio of completed KSE solar installations across Maharashtra. Every project is 
            delivered with premium components, expert engineering, and 30-year reliability.
          </p>
        </div>
        ...
        {active === 'All' && (
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700 overflow-hidden mb-8 grid lg:grid-cols-2">
            {/* Image */}
            <div className="relative h-64 lg:h-auto overflow-hidden group">
              ...
              <div className="absolute bottom-4 left-4 bg-black/50 backdrop-blur-sm rounded-2xl px-5 py-3">
                ...
                <div className="text-xs text-white/70">System Capacity</div>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
              ...
              <div className="grid grid-cols-2 gap-5 mb-6">
                {[
                  { icon: 'location', label: 'Location', value: featured.location },
                  { icon: 'capacity', label: 'Capacity', value: featured.capacity },
                  { icon: 'panels', label: 'Panels', value: featured.panels },
                  { icon: 'tech', label: 'Technology', value: featured.technology },
                ].map((d) => (
              ...
              <a
                href="#contact"
                className="inline-flex items-center gap-2 self-start px-7 py-3.5 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-700 hover:to-emerald-600 text-white font-semibold rounded-full shadow-lg shadow-emerald-500/30 transition-all"
              >
                Get Similar Quote
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {filtered.map((project) => (
            <div
              key={project.title}
              className="group bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-emerald-500/10 border border-slate-100 dark:border-slate-700 hover:border-emerald-200 dark:hover:border-emerald-800 transition-all duration-300 hover:-translate-y-1"
            >
              {/* Image */}
          ...
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-white dark:bg-slate-900 rounded-full shadow-lg border border-slate-100 dark:border-slate-700 px-6 sm:px-8 py-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                Want a similar project for your property?
              </span>
            </div>
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-700 hover:to-emerald-600 text-white text-sm font-semibold rounded-full shadow-lg shadow-emerald-500/30 transition-all whitespace-nowrap"
            >
